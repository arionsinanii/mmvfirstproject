...
require $theme_dir . '/inc/enqueues/tailwind-enqueue.php';
require $theme_dir . '/inc/enqueues/ajax-enqueue.php';
require $theme_dir . '/inc/enqueues/handle-submit-ajax.php';
